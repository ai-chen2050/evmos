...
type QueryAllocationMetersResponse struct {
	...
	AllocationMeters cosmossdk_io_math.LegacyDecCoins `protobuf:"bytes,1,rep,name=allocation_meters,json=allocationMeters,proto3,castrepeated=cosmossdk.io/math.LegacyDecCoins" json:"allocation_meters"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
func (m *QueryAllocationMetersResponse) GetAllocationMeters() cosmossdk_io_math.LegacyDecCoins {
	if m != nil {
...
type QueryAllocationMeterResponse struct {
	...
	AllocationMeter types.DecCoin `protobuf:"bytes,1,opt,name=allocation_meter,json=allocationMeter,proto3,castrepeated=cosmossdk.io/math.LegacyDecCoins" json:"allocation_meter"`
}
...
var fileDescriptor_ee5d2766935e7631 = []byte{
	...
	,
}

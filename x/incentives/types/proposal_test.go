	...
	testCases := []struct {
	...
	}{
		{
			...
			types.Incentive{
				...
				sdk.DecCoins{sdk.NewDecCoinFromDec("ahhub", math.LegacyNewDecWithPrec(5, 2))},
				10,
				time.Now(),
				0,
			},
		...
		},
		{
			...
			types.Incentive{
				utiltx.GenerateAddress().String(),
				sdk.DecCoins{sdk.NewDecCoinFromDec("ahhub", math.LegacyNewDecWithPrec(101, 2))},
				10,
				time.Now(),
				0,
			},
		...
		},
		{
			...
			types.Incentive{
				utiltx.GenerateAddress().String(),
				sdk.DecCoins{sdk.NewDecCoinFromDec("ahhub", math.LegacyNewDecWithPrec(0, 2))},
				10,
				time.Now(),
				0,
			},

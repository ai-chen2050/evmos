...
func (suite *KeeperTestSuite) TestsClaimsRecords() {
	addr1, err := sdk.AccAddressFromBech32("hhub1hf0468jjpe6m6vx38s97z2qqe8ldu0nj67z0pr")
	suite.Require().NoError(err)
	addr2, err := sdk.AccAddressFromBech32("hhub1sv9m0g7ycejwr3s369km58h5qe7xj77hmzdks8")
	suite.Require().NoError(err)
